...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        _______, TG(1),   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            KC_MUTE, _______, KC_MPLY, \
...
led_instruction_t led_instructions[] = {
    ...
    //Layer 1 Colors
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0x407F201F, .id1 = 0x80FC807E, .id2 = 0x10F01F, .r = 255, .layer = 1 }, //red
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0x3F809FE0, .id1 = 0x7F027F81, .id2 = 0x4F07E0, .b = 255, .layer = 1 }, //blue
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0x80000000, .id2 = 0x800, .r = 255, .g = 255, .b = 255, .layer = 1 }, //white
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0x4000, .id1 = 0x10000, .id2 = 0x200000, .r = 255, .g = 179, .layer = 1 }, //amber
    //{ .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_ROTATE_PATTERN, .id2 = 0xFF800000, .id3 = 0x7FFFFF, .layer = 1 }, //pattern
