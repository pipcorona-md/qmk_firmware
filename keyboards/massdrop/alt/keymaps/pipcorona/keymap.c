...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT(
        ...
        L_T_PTD, L_PTP,   L_BRD,   L_PTN,   L_EDG_D, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,          KC_ENT, KC_NO, \
...
led_instruction_t led_instructions[] = {
    ...
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id1 = 0x60000, .r = 255, .layer = 3 }, //red
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .id0 = 0x1FF01FF8, .id1 = 0x22788BF8, .r = 0, .g = 0, .b = 0, .layer = 3 }, //null off
